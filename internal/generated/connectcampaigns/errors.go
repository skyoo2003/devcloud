...
// InvalidCampaignStateException is returned with HTTP status 409.
type InvalidCampaignStateException struct {
	Message string
}

func (e *InvalidCampaignStateException) Error() string {
	return fmt.Sprintf("InvalidCampaignStateException: %s", e.Message)
}
...
func (e *InvalidCampaignStateException) HTTPStatus() int {
	return 409
}

// InvalidStateException is returned with HTTP status 409.
