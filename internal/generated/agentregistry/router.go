...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/discoverable-records-batch", Operation: "BatchGetDiscoverableRegistryRecord"},
	{Method: "POST", Pattern: "/registries/{registryId}/discoverable-records-list", Operation: "ListDiscoverableRegistryRecords"},
	{Method: "POST", Pattern: "/discoverable-records-search", Operation: "SearchDiscoverableRegistryRecords"},
}
