...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/v1/get-ice-server-config", Operation: "GetIceServerConfig"},
	{Method: "POST", Pattern: "/v1/send-alexa-offer-to-master", Operation: "SendAlexaOfferToMaster"},
}
