...
// OcuLimitExceededException is returned with HTTP status 402.
type OcuLimitExceededException struct {
	Message string
}

func (e *OcuLimitExceededException) Error() string {
	return fmt.Sprintf("OcuLimitExceededException: %s", e.Message)
}
...
func (e *OcuLimitExceededException) HTTPStatus() int {
	return 402
}
