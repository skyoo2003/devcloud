...
var OperationRoutes = []OperationRoute{
	{Method: "DELETE", Pattern: "/{Path+}", Operation: "DeleteObject"},
	{Method: "HEAD", Pattern: "/{Path+}", Operation: "DescribeObject"},
	{Method: "GET", Pattern: "/{Path+}", Operation: "GetObject"},
	{Method: "GET", Pattern: "/", Operation: "ListItems"},
	{Method: "PUT", Pattern: "/{Path+}", Operation: "PutObject"},
}
