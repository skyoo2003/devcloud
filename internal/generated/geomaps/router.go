...
var OperationRoutes = []OperationRoute{
	{Method: "GET", Pattern: "/v2/glyphs/{FontStack}/{FontUnicodeRange}", Operation: "GetGlyphs"},
	{Method: "GET", Pattern: "/v2/styles/{Style}/{ColorScheme}/{Variant}/sprites/{FileName}", Operation: "GetSprites"},
	{Method: "GET", Pattern: "/v2/static/{FileName}", Operation: "GetStaticMap"},
	{Method: "GET", Pattern: "/v2/styles/{Style}/descriptor", Operation: "GetStyleDescriptor"},
	{Method: "GET", Pattern: "/v2/tiles/{Tileset}/{Z}/{X}/{Y}", Operation: "GetTile"},
}
