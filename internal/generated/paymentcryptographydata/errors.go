...
// VerificationFailedException is returned with HTTP status 400.
type VerificationFailedException struct {
	Message string
}

func (e *VerificationFailedException) Error() string {
	return fmt.Sprintf("VerificationFailedException: %s", e.Message)
}
...
func (e *VerificationFailedException) HTTPStatus() int {
	return 400
}
