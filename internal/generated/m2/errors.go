...
// ExecutionTimeoutException is returned with HTTP status 504.
type ExecutionTimeoutException struct {
	Message string
}

func (e *ExecutionTimeoutException) Error() string {
	return fmt.Sprintf("ExecutionTimeoutException: %s", e.Message)
}
...
func (e *ExecutionTimeoutException) HTTPStatus() int {
	return 504
}
