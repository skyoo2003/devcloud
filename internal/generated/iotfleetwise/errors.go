...
// DecoderManifestValidationException is returned with HTTP status 400.
type DecoderManifestValidationException struct {
	Message string
}

func (e *DecoderManifestValidationException) Error() string {
	return fmt.Sprintf("DecoderManifestValidationException: %s", e.Message)
}
...
func (e *DecoderManifestValidationException) HTTPStatus() int {
	return 400
}
...
// InvalidNodeException is returned with HTTP status 400.
type InvalidNodeException struct {
	Message string
}

func (e *InvalidNodeException) Error() string {
	return fmt.Sprintf("InvalidNodeException: %s", e.Message)
}
...
func (e *InvalidNodeException) HTTPStatus() int {
	return 400
}

// InvalidSignalsException is returned with HTTP status 400.
type InvalidSignalsException struct {
	Message string
}

func (e *InvalidSignalsException) Error() string {
	return fmt.Sprintf("InvalidSignalsException: %s", e.Message)
}
...
func (e *InvalidSignalsException) HTTPStatus() int {
	return 400
}
