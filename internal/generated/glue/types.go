...
type DataQualityRuleRecommendationRunDescription struct {
	...
	DataSource         *DataSource `json:"dataSource" xml:"DataSource"`
	RecommendationMode string      `json:"recommendationMode" xml:"RecommendationMode"`
	RunId              string      `json:"runId" xml:"RunId"`
	StartedOn          time.Time   `json:"startedOn" xml:"StartedOn"`
	Status             string      `json:"status" xml:"Status"`
}
...
type IntegrationTablePropertiesFilter struct {
	Name   string                                 `json:"name" xml:"Name"`
	Values IntegrationTablePropertiesFilterValues `json:"values" xml:"Values"`
}
...
type ListIntegrationTablePropertiesRequest struct {
	Filters    IntegrationTablePropertiesFilterList `json:"filters" xml:"Filters"`
	Marker     string                               `json:"marker" xml:"Marker"`
	MaxRecords int32                                `json:"maxRecords" xml:"MaxRecords"`
}

type ListIntegrationTablePropertiesResponse struct {
	IntegrationTablePropertiesList IntegrationTablePropertiesList `json:"integrationTablePropertiesList" xml:"IntegrationTablePropertiesList"`
	Marker                         string                         `json:"marker" xml:"Marker"`
}
...
type IntegrationTablePropertiesFilterList []*IntegrationTablePropertiesFilter

type IntegrationTablePropertiesFilterValues []string

type IntegrationTablePropertiesList []*IntegrationTableProperties
