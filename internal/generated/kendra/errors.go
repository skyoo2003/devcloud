...
// FeaturedResultsConflictException is returned with HTTP status 409.
type FeaturedResultsConflictException struct {
	Message string
}

func (e *FeaturedResultsConflictException) Error() string {
	return fmt.Sprintf("FeaturedResultsConflictException: %s", e.Message)
}
...
func (e *FeaturedResultsConflictException) HTTPStatus() int {
	return 409
}
...
// ResourceAlreadyExistException is returned with HTTP status 400.
type ResourceAlreadyExistException struct {
	Message string
}

func (e *ResourceAlreadyExistException) Error() string {
	return fmt.Sprintf("ResourceAlreadyExistException: %s", e.Message)
}
...
func (e *ResourceAlreadyExistException) HTTPStatus() int {
	return 400
}
