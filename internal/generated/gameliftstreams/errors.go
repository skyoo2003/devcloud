...
// StreamSessionAccessNotReadyException is returned with HTTP status 409.
type StreamSessionAccessNotReadyException struct {
	Message string
}

func (e *StreamSessionAccessNotReadyException) Error() string {
	return fmt.Sprintf("StreamSessionAccessNotReadyException: %s", e.Message)
}
...
func (e *StreamSessionAccessNotReadyException) HTTPStatus() int {
	return 409
}
