...
// ContentTooLargeException is returned with HTTP status 413.
type ContentTooLargeException struct {
	Message string
}

func (e *ContentTooLargeException) Error() string {
	return fmt.Sprintf("ContentTooLargeException: %s", e.Message)
}
...
func (e *ContentTooLargeException) HTTPStatus() int {
	return 413
}
