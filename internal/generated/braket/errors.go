...
// DeviceOfflineException is returned with HTTP status 424.
type DeviceOfflineException struct {
	Message string
}

func (e *DeviceOfflineException) Error() string {
	return fmt.Sprintf("DeviceOfflineException: %s", e.Message)
}
...
func (e *DeviceOfflineException) HTTPStatus() int {
	return 424
}

// DeviceRetiredException is returned with HTTP status 410.
type DeviceRetiredException struct {
	Message string
}

func (e *DeviceRetiredException) Error() string {
	return fmt.Sprintf("DeviceRetiredException: %s", e.Message)
}
...
func (e *DeviceRetiredException) HTTPStatus() int {
	return 410
}
