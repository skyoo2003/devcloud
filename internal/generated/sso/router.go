...
var OperationRoutes = []OperationRoute{
	{Method: "GET", Pattern: "/federation/credentials", Operation: "GetRoleCredentials"},
	{Method: "GET", Pattern: "/assignment/roles", Operation: "ListAccountRoles"},
	{Method: "GET", Pattern: "/assignment/accounts", Operation: "ListAccounts"},
	{Method: "POST", Pattern: "/logout", Operation: "Logout"},
}
