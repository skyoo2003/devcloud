...
// AlreadyCreatedException is returned with HTTP status 0.
type AlreadyCreatedException struct {
	Message string
}

func (e *AlreadyCreatedException) Error() string {
	return fmt.Sprintf("AlreadyCreatedException: %s", e.Message)
}

func (e *AlreadyCreatedException) ErrorCode() string {
	return "AlreadyCreatedException"
}

func (e *AlreadyCreatedException) HTTPStatus() int {
	return 0
}
