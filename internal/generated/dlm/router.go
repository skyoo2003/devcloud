...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/policies", Operation: "CreateLifecyclePolicy"},
	{Method: "DELETE", Pattern: "/policies/{PolicyId}", Operation: "DeleteLifecyclePolicy"},
	{Method: "GET", Pattern: "/policies", Operation: "GetLifecyclePolicies"},
	{Method: "GET", Pattern: "/policies/{PolicyId}", Operation: "GetLifecyclePolicy"},
	...
	{Method: "PATCH", Pattern: "/policies/{PolicyId}", Operation: "UpdateLifecyclePolicy"},
}
