...
// QueryExecutionException is returned with HTTP status 400.
type QueryExecutionException struct {
	Message string
}

func (e *QueryExecutionException) Error() string {
	return fmt.Sprintf("QueryExecutionException: %s", e.Message)
}
...
func (e *QueryExecutionException) HTTPStatus() int {
	return 400
}
