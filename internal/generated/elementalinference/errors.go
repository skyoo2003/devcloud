...
// GatewayTimedOutException is returned with HTTP status 504.
type GatewayTimedOutException struct {
	Message string
}

func (e *GatewayTimedOutException) Error() string {
	return fmt.Sprintf("GatewayTimedOutException: %s", e.Message)
}
...
func (e *GatewayTimedOutException) HTTPStatus() int {
	return 504
}
...
// TooManyRequestException is returned with HTTP status 429.
type TooManyRequestException struct {
	Message string
}

func (e *TooManyRequestException) Error() string {
	return fmt.Sprintf("TooManyRequestException: %s", e.Message)
}
...
func (e *TooManyRequestException) HTTPStatus() int {
	return 429
}
