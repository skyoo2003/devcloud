...
// RequestAlreadyInProgressException is returned with HTTP status 400.
type RequestAlreadyInProgressException struct {
	Message string
}

func (e *RequestAlreadyInProgressException) Error() string {
	return fmt.Sprintf("RequestAlreadyInProgressException: %s", e.Message)
}
...
func (e *RequestAlreadyInProgressException) HTTPStatus() int {
	return 400
}
