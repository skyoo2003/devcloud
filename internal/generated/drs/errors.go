...
// UninitializedAccountException is returned with HTTP status 400.
type UninitializedAccountException struct {
	Message string
}

func (e *UninitializedAccountException) Error() string {
	return fmt.Sprintf("UninitializedAccountException: %s", e.Message)
}
...
func (e *UninitializedAccountException) HTTPStatus() int {
	return 400
}
