...
// DataEncryptionException is returned with HTTP status 400.
type DataEncryptionException struct {
	Message string
}

func (e *DataEncryptionException) Error() string {
	return fmt.Sprintf("DataEncryptionException: %s", e.Message)
}
...
func (e *DataEncryptionException) HTTPStatus() int {
	return 400
}
