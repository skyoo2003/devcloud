...
// EndpointTemporarilyUnavailableException is returned with HTTP status 503.
type EndpointTemporarilyUnavailableException struct {
	Message string
}

func (e *EndpointTemporarilyUnavailableException) Error() string {
	return fmt.Sprintf("EndpointTemporarilyUnavailableException: %s", e.Message)
}
...
func (e *EndpointTemporarilyUnavailableException) HTTPStatus() int {
	return 503
}
