...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/token", Operation: "CreateToken"},
	{Method: "POST", Pattern: "/token?aws_iam=t", Operation: "CreateTokenWithIAM"},
	{Method: "POST", Pattern: "/client/register", Operation: "RegisterClient"},
	{Method: "POST", Pattern: "/device_authorization", Operation: "StartDeviceAuthorization"},
}
