...
// DependencyException is returned with HTTP status 500.
...
// ServiceLinkedRoleLockClientException is returned with HTTP status 400.
type ServiceLinkedRoleLockClientException struct {
	Message string
}

func (e *ServiceLinkedRoleLockClientException) Error() string {
	return fmt.Sprintf("ServiceLinkedRoleLockClientException: %s", e.Message)
}
...
func (e *ServiceLinkedRoleLockClientException) HTTPStatus() int {
	return 400
}
