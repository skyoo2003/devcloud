...
var OperationRoutes = []OperationRoute{
	{Method: "GET", Pattern: "/2013-01-01/search?format=sdk&pretty=true", Operation: "Search"},
	{Method: "GET", Pattern: "/2013-01-01/suggest?format=sdk&pretty=true", Operation: "Suggest"},
	{Method: "POST", Pattern: "/2013-01-01/documents/batch?format=sdk", Operation: "UploadDocuments"},
}
