...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/endpoints/{EndpointName}/invocations", Operation: "InvokeEndpoint"},
	{Method: "POST", Pattern: "/endpoints/{EndpointName}/async-invocations", Operation: "InvokeEndpointAsync"},
	{Method: "POST", Pattern: "/endpoints/{EndpointName}/invocations-response-stream", Operation: "InvokeEndpointWithResponseStream"},
}
