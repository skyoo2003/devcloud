...
// CoreNetworkPolicyException is returned with HTTP status 400.
type CoreNetworkPolicyException struct {
	Message string
}

func (e *CoreNetworkPolicyException) Error() string {
	return fmt.Sprintf("CoreNetworkPolicyException: %s", e.Message)
}
...
func (e *CoreNetworkPolicyException) HTTPStatus() int {
	return 400
}
