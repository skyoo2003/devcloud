...
// RejectedRecordsException is returned with HTTP status 419.
type RejectedRecordsException struct {
	Message string
}

func (e *RejectedRecordsException) Error() string {
	return fmt.Sprintf("RejectedRecordsException: %s", e.Message)
}
...
func (e *RejectedRecordsException) HTTPStatus() int {
	return 419
}
