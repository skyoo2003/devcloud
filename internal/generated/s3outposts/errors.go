...
// OutpostOfflineException is returned with HTTP status 400.
type OutpostOfflineException struct {
	Message string
}

func (e *OutpostOfflineException) Error() string {
	return fmt.Sprintf("OutpostOfflineException: %s", e.Message)
}
...
func (e *OutpostOfflineException) HTTPStatus() int {
	return 400
}
