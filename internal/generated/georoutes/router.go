...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/v2/isolines", Operation: "CalculateIsolines"},
	{Method: "POST", Pattern: "/v2/route-matrix", Operation: "CalculateRouteMatrix"},
	{Method: "POST", Pattern: "/v2/routes", Operation: "CalculateRoutes"},
	{Method: "POST", Pattern: "/v2/optimize-waypoints", Operation: "OptimizeWaypoints"},
	{Method: "POST", Pattern: "/v2/snap-to-roads", Operation: "SnapToRoads"},
}
