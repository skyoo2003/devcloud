...
// UnprocessableException is returned with HTTP status 422.
type UnprocessableException struct {
	Message string
}

func (e *UnprocessableException) Error() string {
	return fmt.Sprintf("UnprocessableException: %s", e.Message)
}
...
func (e *UnprocessableException) HTTPStatus() int {
	return 422
}
