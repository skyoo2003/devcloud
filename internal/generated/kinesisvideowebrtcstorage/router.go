...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/joinStorageSession", Operation: "JoinStorageSession"},
	{Method: "POST", Pattern: "/joinStorageSessionAsViewer", Operation: "JoinStorageSessionAsViewer"},
}
