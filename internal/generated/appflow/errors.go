...
// ConnectorAuthenticationException is returned with HTTP status 401.
type ConnectorAuthenticationException struct {
	Message string
}

func (e *ConnectorAuthenticationException) Error() string {
	return fmt.Sprintf("ConnectorAuthenticationException: %s", e.Message)
}
...
func (e *ConnectorAuthenticationException) HTTPStatus() int {
	return 401
}

// ConnectorServerException is returned with HTTP status 400.
type ConnectorServerException struct {
	Message string
}

func (e *ConnectorServerException) Error() string {
	return fmt.Sprintf("ConnectorServerException: %s", e.Message)
}
...
func (e *ConnectorServerException) HTTPStatus() int {
	return 400
}
