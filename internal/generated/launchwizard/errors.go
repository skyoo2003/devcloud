...
// ResourceLimitException is returned with HTTP status 400.
type ResourceLimitException struct {
	Message string
}

func (e *ResourceLimitException) Error() string {
	return fmt.Sprintf("ResourceLimitException: %s", e.Message)
}
...
func (e *ResourceLimitException) HTTPStatus() int {
	return 400
}
