...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/rules", Operation: "CreateRule"},
	{Method: "DELETE", Pattern: "/rules/{Identifier}", Operation: "DeleteRule"},
	{Method: "GET", Pattern: "/rules/{Identifier}", Operation: "GetRule"},
	{Method: "POST", Pattern: "/list-rules", Operation: "ListRules"},
	{Method: "GET", Pattern: "/tags/{ResourceArn}", Operation: "ListTagsForResource"},
	{Method: "PATCH", Pattern: "/rules/{Identifier}/lock", Operation: "LockRule"},
	{Method: "POST", Pattern: "/tags/{ResourceArn}", Operation: "TagResource"},
	{Method: "PATCH", Pattern: "/rules/{Identifier}/unlock", Operation: "UnlockRule"},
	{Method: "DELETE", Pattern: "/tags/{ResourceArn}", Operation: "UntagResource"},
	{Method: "PATCH", Pattern: "/rules/{Identifier}", Operation: "UpdateRule"},
}
