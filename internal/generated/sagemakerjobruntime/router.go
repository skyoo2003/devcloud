...
var OperationRoutes = []OperationRoute{
	{Method: "POST", Pattern: "/complete-rollout", Operation: "CompleteRollout"},
	{Method: "POST", Pattern: "/sample", Operation: "Sample"},
	{Method: "POST", Pattern: "/sample-with-response-stream", Operation: "SampleWithResponseStream"},
	{Method: "POST", Pattern: "/update-reward", Operation: "UpdateReward"},
}
