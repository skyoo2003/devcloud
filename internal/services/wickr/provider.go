...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/wickr"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WickrAdminApi service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "wickr" }
func (p *Provider) ServiceName() string           { return "WickrAdminApi" }
...
func init() {
	plugin.DefaultRegistry.Register("wickr", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
