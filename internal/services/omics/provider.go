...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/omics"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Omics service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "omics" }
func (p *Provider) ServiceName() string           { return "Omics" }
...
func init() {
	plugin.DefaultRegistry.Register("omics", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
