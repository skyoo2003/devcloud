...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/migrationhub"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MigrationHub service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "migrationhub" }
func (p *Provider) ServiceName() string           { return "MigrationHub" }
...
func init() {
	plugin.DefaultRegistry.Register("migrationhub", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
