...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/trustedadvisor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the TrustedAdvisor service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "trustedadvisor" }
func (p *Provider) ServiceName() string           { return "TrustedAdvisor" }
...
func init() {
	plugin.DefaultRegistry.Register("trustedadvisor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
