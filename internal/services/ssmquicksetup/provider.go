...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ssmquicksetup"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the QuickSetup service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ssmquicksetup" }
func (p *Provider) ServiceName() string           { return "QuickSetup" }
...
func init() {
	plugin.DefaultRegistry.Register("ssmquicksetup", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
