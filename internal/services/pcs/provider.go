...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pcs"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ParallelComputingService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pcs" }
func (p *Provider) ServiceName() string           { return "ParallelComputingService" }
...
func init() {
	plugin.DefaultRegistry.Register("pcs", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
