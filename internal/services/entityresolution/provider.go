...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/entityresolution"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the VeniceService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "entityresolution" }
func (p *Provider) ServiceName() string           { return "VeniceService" }
...
func init() {
	plugin.DefaultRegistry.Register("entityresolution", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
