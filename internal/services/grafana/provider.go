...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/grafana"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GrafanaControlPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "grafana" }
func (p *Provider) ServiceName() string           { return "GrafanaControlPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("grafana", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
