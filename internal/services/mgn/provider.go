...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mgn"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ApplicationMigrationService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mgn" }
func (p *Provider) ServiceName() string           { return "ApplicationMigrationService" }
...
func init() {
	plugin.DefaultRegistry.Register("mgn", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
