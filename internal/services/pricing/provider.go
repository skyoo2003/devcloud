...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pricing"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PriceListService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pricing" }
func (p *Provider) ServiceName() string           { return "PriceListService" }
...
func init() {
	plugin.DefaultRegistry.Register("pricing", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
