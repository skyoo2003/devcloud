...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/migrationhubconfig"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MigrationHubMultiAccountService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "migrationhubconfig" }
func (p *Provider) ServiceName() string           { return "MigrationHubMultiAccountService" }
...
func init() {
	plugin.DefaultRegistry.Register("migrationhubconfig", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
