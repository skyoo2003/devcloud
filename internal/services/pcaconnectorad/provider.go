...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pcaconnectorad"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PcaConnectorAd service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pcaconnectorad" }
func (p *Provider) ServiceName() string           { return "PcaConnectorAd" }
...
func init() {
	plugin.DefaultRegistry.Register("pcaconnectorad", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
