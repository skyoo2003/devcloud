...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/arczonalshift"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PercDataPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "arczonalshift" }
func (p *Provider) ServiceName() string           { return "PercDataPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("arczonalshift", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
