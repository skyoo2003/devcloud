...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/geoplaces"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PlacesService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "geoplaces" }
func (p *Provider) ServiceName() string           { return "PlacesService" }
...
func init() {
	plugin.DefaultRegistry.Register("geoplaces", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
