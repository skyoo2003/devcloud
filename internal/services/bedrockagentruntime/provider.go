...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockagentruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockAgentRunTimeService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockagentruntime" }
func (p *Provider) ServiceName() string           { return "BedrockAgentRunTimeService" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockagentruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
