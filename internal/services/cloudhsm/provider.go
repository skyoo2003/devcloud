...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cloudhsm"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CloudHsmFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cloudhsm" }
func (p *Provider) ServiceName() string           { return "CloudHsmFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("cloudhsm", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
