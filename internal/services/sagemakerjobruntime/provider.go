...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sagemakerjobruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AgenticRFTRuntimeService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sagemakerjobruntime" }
func (p *Provider) ServiceName() string           { return "AgenticRFTRuntimeService" }
...
func init() {
	plugin.DefaultRegistry.Register("sagemakerjobruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
