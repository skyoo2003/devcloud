...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kafkaconnect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KafkaConnect service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kafkaconnect" }
func (p *Provider) ServiceName() string           { return "KafkaConnect" }
...
func init() {
	plugin.DefaultRegistry.Register("kafkaconnect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
