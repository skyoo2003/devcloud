...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/neptunedata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NeptuneDataplane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "neptunedata" }
func (p *Provider) ServiceName() string           { return "NeptuneDataplane" }
...
func init() {
	plugin.DefaultRegistry.Register("neptunedata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
