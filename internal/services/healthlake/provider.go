...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/healthlake"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the HealthLake service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "healthlake" }
func (p *Provider) ServiceName() string           { return "HealthLake" }
...
func init() {
	plugin.DefaultRegistry.Register("healthlake", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
