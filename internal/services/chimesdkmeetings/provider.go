...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chimesdkmeetings"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ChimeMeetingsSDKService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chimesdkmeetings" }
func (p *Provider) ServiceName() string           { return "ChimeMeetingsSDKService" }
...
func init() {
	plugin.DefaultRegistry.Register("chimesdkmeetings", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
