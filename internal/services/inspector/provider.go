...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/inspector"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the InspectorService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "inspector" }
func (p *Provider) ServiceName() string           { return "InspectorService" }
...
func init() {
	plugin.DefaultRegistry.Register("inspector", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
