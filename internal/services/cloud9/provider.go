...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cloud9"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Cloud9WorkspaceManagementService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cloud9" }
func (p *Provider) ServiceName() string           { return "Cloud9WorkspaceManagementService" }
...
func init() {
	plugin.DefaultRegistry.Register("cloud9", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
