...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/licensemanagerusersubscriptions"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LicenseManagerUserSubscriptions service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "licensemanagerusersubscriptions" }
func (p *Provider) ServiceName() string           { return "LicenseManagerUserSubscriptions" }
...
func init() {
	plugin.DefaultRegistry.Register("licensemanagerusersubscriptions", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
