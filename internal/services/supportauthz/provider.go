...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/supportauthz"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SupportAuthZ service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "supportauthz" }
func (p *Provider) ServiceName() string           { return "SupportAuthZ" }
...
func init() {
	plugin.DefaultRegistry.Register("supportauthz", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
