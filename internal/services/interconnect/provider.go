...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/interconnect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Interconnect service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "interconnect" }
func (p *Provider) ServiceName() string           { return "Interconnect" }
...
func init() {
	plugin.DefaultRegistry.Register("interconnect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
