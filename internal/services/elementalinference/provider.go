...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/elementalinference"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ElementalInference service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "elementalinference" }
func (p *Provider) ServiceName() string           { return "ElementalInference" }
...
func init() {
	plugin.DefaultRegistry.Register("elementalinference", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
