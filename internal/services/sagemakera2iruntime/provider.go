...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sagemakera2iruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SageMakerA2IRuntime service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sagemakera2iruntime" }
func (p *Provider) ServiceName() string           { return "SageMakerA2IRuntime" }
...
func init() {
	plugin.DefaultRegistry.Register("sagemakera2iruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
