...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/controltower"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ControlTowerApis service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "controltower" }
func (p *Provider) ServiceName() string           { return "ControlTowerApis" }
...
func init() {
	plugin.DefaultRegistry.Register("controltower", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
