...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pricingplanmanager"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PricingPlanManager service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pricingplanmanager" }
func (p *Provider) ServiceName() string           { return "PricingPlanManager" }
...
func init() {
	plugin.DefaultRegistry.Register("pricingplanmanager", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
