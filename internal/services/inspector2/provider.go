...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/inspector2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Inspector2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "inspector2" }
func (p *Provider) ServiceName() string           { return "Inspector2" }
...
func init() {
	plugin.DefaultRegistry.Register("inspector2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
