...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workspaces"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WorkspacesService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workspaces" }
func (p *Provider) ServiceName() string           { return "WorkspacesService" }
...
func init() {
	plugin.DefaultRegistry.Register("workspaces", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
