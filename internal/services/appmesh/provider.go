...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/appmesh"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AppMesh service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "appmesh" }
func (p *Provider) ServiceName() string           { return "AppMesh" }
...
func init() {
	plugin.DefaultRegistry.Register("appmesh", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
