...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/forecast"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Forecast service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "forecast" }
func (p *Provider) ServiceName() string           { return "Forecast" }
...
func init() {
	plugin.DefaultRegistry.Register("forecast", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
