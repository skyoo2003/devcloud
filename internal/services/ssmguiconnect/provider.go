...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ssmguiconnect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SSMGuiConnect service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ssmguiconnect" }
func (p *Provider) ServiceName() string           { return "SSMGuiConnect" }
...
func init() {
	plugin.DefaultRegistry.Register("ssmguiconnect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
