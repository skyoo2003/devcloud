...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sustainability"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AwsSustainabilityApiService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sustainability" }
func (p *Provider) ServiceName() string           { return "AwsSustainabilityApiService" }
...
func init() {
	plugin.DefaultRegistry.Register("sustainability", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
