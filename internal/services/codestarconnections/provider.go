...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/codestarconnections"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CodeStar_connections_20191201 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "codestarconnections" }
func (p *Provider) ServiceName() string           { return "CodeStar_connections_20191201" }
...
func init() {
	plugin.DefaultRegistry.Register("codestarconnections", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
