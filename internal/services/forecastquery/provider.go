...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/forecastquery"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ForecastRuntime service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "forecastquery" }
func (p *Provider) ServiceName() string           { return "ForecastRuntime" }
...
func init() {
	plugin.DefaultRegistry.Register("forecastquery", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
