...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/clouddirectory"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CloudDirectory_20170111 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "clouddirectory" }
func (p *Provider) ServiceName() string           { return "CloudDirectory_20170111" }
...
func init() {
	plugin.DefaultRegistry.Register("clouddirectory", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
