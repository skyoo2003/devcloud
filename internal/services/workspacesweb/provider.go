...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workspacesweb"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ErmineControlPlaneService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workspacesweb" }
func (p *Provider) ServiceName() string           { return "ErmineControlPlaneService" }
...
func init() {
	plugin.DefaultRegistry.Register("workspacesweb", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
