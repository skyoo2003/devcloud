...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/supplychain"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GalaxyPublicAPIGateway service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "supplychain" }
func (p *Provider) ServiceName() string           { return "GalaxyPublicAPIGateway" }
...
func init() {
	plugin.DefaultRegistry.Register("supplychain", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
