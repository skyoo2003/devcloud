...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/rum"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RUM service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "rum" }
func (p *Provider) ServiceName() string           { return "RUM" }
...
func init() {
	plugin.DefaultRegistry.Register("rum", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
