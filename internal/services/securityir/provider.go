...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/securityir"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SecurityIncidentResponse service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "securityir" }
func (p *Provider) ServiceName() string           { return "SecurityIncidentResponse" }
...
func init() {
	plugin.DefaultRegistry.Register("securityir", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
