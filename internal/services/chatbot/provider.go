...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chatbot"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WheatleyOrchestration_20171011 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chatbot" }
func (p *Provider) ServiceName() string           { return "WheatleyOrchestration_20171011" }
...
func init() {
	plugin.DefaultRegistry.Register("chatbot", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
