...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/migrationhuborchestrator"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MigrationHubOrchestrator service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "migrationhuborchestrator" }
func (p *Provider) ServiceName() string           { return "MigrationHubOrchestrator" }
...
func init() {
	plugin.DefaultRegistry.Register("migrationhuborchestrator", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
