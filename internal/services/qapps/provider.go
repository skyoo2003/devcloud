...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/qapps"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the QAppsService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "qapps" }
func (p *Provider) ServiceName() string           { return "QAppsService" }
...
func init() {
	plugin.DefaultRegistry.Register("qapps", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
