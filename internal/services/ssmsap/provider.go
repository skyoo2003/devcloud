...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ssmsap"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SsmSap service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ssmsap" }
func (p *Provider) ServiceName() string           { return "SsmSap" }
...
func init() {
	plugin.DefaultRegistry.Register("ssmsap", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
