...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/directoryservice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DirectoryService_20150416 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "directoryservice" }
func (p *Provider) ServiceName() string           { return "DirectoryService_20150416" }
...
func init() {
	plugin.DefaultRegistry.Register("directoryservice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
