...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/transcribestreaming"
...
func (p *Provider) ServiceID() string             { return "transcribestreaming" }
...
func init() {
	plugin.DefaultRegistry.Register("transcribestreaming", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
