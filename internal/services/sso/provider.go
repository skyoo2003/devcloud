...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sso"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SWBPortalService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sso" }
func (p *Provider) ServiceName() string           { return "SWBPortalService" }
...
func init() {
	plugin.DefaultRegistry.Register("sso", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
