...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/internetmonitor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the InternetMonitor20210603 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "internetmonitor" }
func (p *Provider) ServiceName() string           { return "InternetMonitor20210603" }
...
func init() {
	plugin.DefaultRegistry.Register("internetmonitor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
