...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kinesisvideomedia"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AcuityInletService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kinesisvideomedia" }
func (p *Provider) ServiceName() string           { return "AcuityInletService" }
...
func init() {
	plugin.DefaultRegistry.Register("kinesisvideomedia", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
