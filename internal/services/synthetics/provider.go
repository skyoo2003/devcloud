...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/synthetics"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Synthetics service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "synthetics" }
func (p *Provider) ServiceName() string           { return "Synthetics" }
...
func init() {
	plugin.DefaultRegistry.Register("synthetics", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
