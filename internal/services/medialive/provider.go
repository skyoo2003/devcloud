...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/medialive"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaLive service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "medialive" }
func (p *Provider) ServiceName() string           { return "MediaLive" }
...
func init() {
	plugin.DefaultRegistry.Register("medialive", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
