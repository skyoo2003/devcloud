...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/costandusagereportservice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the OrigamiServiceGatewayService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "costandusagereportservice" }
func (p *Provider) ServiceName() string           { return "OrigamiServiceGatewayService" }
...
func init() {
	plugin.DefaultRegistry.Register("costandusagereportservice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
