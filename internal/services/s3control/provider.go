...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/s3control"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the S3ControlServiceV20180820 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "s3control" }
func (p *Provider) ServiceName() string           { return "S3ControlServiceV20180820" }
...
func init() {
	plugin.DefaultRegistry.Register("s3control", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
