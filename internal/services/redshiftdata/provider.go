...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/redshiftdata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RedshiftData service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "redshiftdata" }
func (p *Provider) ServiceName() string           { return "RedshiftData" }
...
func init() {
	plugin.DefaultRegistry.Register("redshiftdata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
