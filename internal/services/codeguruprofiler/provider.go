...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/codeguruprofiler"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CodeGuruProfiler service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "codeguruprofiler" }
func (p *Provider) ServiceName() string           { return "CodeGuruProfiler" }
...
func init() {
	plugin.DefaultRegistry.Register("codeguruprofiler", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
