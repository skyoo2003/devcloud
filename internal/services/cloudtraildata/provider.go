...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cloudtraildata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CloudTrailDataService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cloudtraildata" }
func (p *Provider) ServiceName() string           { return "CloudTrailDataService" }
...
func init() {
	plugin.DefaultRegistry.Register("cloudtraildata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
