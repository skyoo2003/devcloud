...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workmail"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WorkMailService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workmail" }
func (p *Provider) ServiceName() string           { return "WorkMailService" }
...
func init() {
	plugin.DefaultRegistry.Register("workmail", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
