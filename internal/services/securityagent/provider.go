...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/securityagent"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SecurityAgent service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "securityagent" }
func (p *Provider) ServiceName() string           { return "SecurityAgent" }
...
func init() {
	plugin.DefaultRegistry.Register("securityagent", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
