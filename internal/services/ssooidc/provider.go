...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ssooidc"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SSOOIDCService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ssooidc" }
func (p *Provider) ServiceName() string           { return "SSOOIDCService" }
...
func init() {
	plugin.DefaultRegistry.Register("ssooidc", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
