...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/devopsagent"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DevOpsAgent service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "devopsagent" }
func (p *Provider) ServiceName() string           { return "DevOpsAgent" }
...
func init() {
	plugin.DefaultRegistry.Register("devopsagent", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
