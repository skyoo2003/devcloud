...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workdocs"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GorillaBoyService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workdocs" }
func (p *Provider) ServiceName() string           { return "GorillaBoyService" }
...
func init() {
	plugin.DefaultRegistry.Register("workdocs", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
