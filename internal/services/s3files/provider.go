...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/s3files"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the S3Files service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "s3files" }
func (p *Provider) ServiceName() string           { return "S3Files" }
...
func init() {
	plugin.DefaultRegistry.Register("s3files", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
