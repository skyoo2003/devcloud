...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/dsql"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DSQL service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "dsql" }
func (p *Provider) ServiceName() string           { return "DSQL" }
...
func init() {
	plugin.DefaultRegistry.Register("dsql", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
