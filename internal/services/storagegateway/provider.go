...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/storagegateway"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the StorageGateway_20130630 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "storagegateway" }
func (p *Provider) ServiceName() string           { return "StorageGateway_20130630" }
...
func init() {
	plugin.DefaultRegistry.Register("storagegateway", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
