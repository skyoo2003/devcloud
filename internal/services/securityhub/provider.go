...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/securityhub"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SecurityHubAPIService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "securityhub" }
func (p *Provider) ServiceName() string           { return "SecurityHubAPIService" }
...
func init() {
	plugin.DefaultRegistry.Register("securityhub", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
