...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lambdamicrovms"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LambdaMicrovms service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lambdamicrovms" }
func (p *Provider) ServiceName() string           { return "LambdaMicrovms" }
...
func init() {
	plugin.DefaultRegistry.Register("lambdamicrovms", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
