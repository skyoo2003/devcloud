...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/novaact"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NovaAgentsDataPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "novaact" }
func (p *Provider) ServiceName() string           { return "NovaAgentsDataPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("novaact", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
