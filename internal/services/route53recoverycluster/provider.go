...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/route53recoverycluster"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ToggleCustomerAPI service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "route53recoverycluster" }
func (p *Provider) ServiceName() string           { return "ToggleCustomerAPI" }
...
func init() {
	plugin.DefaultRegistry.Register("route53recoverycluster", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
