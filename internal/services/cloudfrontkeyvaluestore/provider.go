...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cloudfrontkeyvaluestore"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CloudFrontKeyValueStore service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cloudfrontkeyvaluestore" }
func (p *Provider) ServiceName() string           { return "CloudFrontKeyValueStore" }
...
func init() {
	plugin.DefaultRegistry.Register("cloudfrontkeyvaluestore", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
