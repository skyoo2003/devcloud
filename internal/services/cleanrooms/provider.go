...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cleanrooms"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BastionControlPlaneServiceLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cleanrooms" }
func (p *Provider) ServiceName() string           { return "BastionControlPlaneServiceLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("cleanrooms", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
