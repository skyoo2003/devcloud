...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplacereporting"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MarketplaceReporting service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplacereporting" }
func (p *Provider) ServiceName() string           { return "MarketplaceReporting" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplacereporting", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
