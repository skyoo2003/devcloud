...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/route53globalresolver"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the EC2DNSGlobalResolverCustomerAPI service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "route53globalresolver" }
func (p *Provider) ServiceName() string           { return "EC2DNSGlobalResolverCustomerAPI" }
...
func init() {
	plugin.DefaultRegistry.Register("route53globalresolver", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
