...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connectcampaigns"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectCampaignService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connectcampaigns" }
func (p *Provider) ServiceName() string           { return "ConnectCampaignService" }
...
func init() {
	plugin.DefaultRegistry.Register("connectcampaigns", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
