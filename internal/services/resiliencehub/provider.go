...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/resiliencehub"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AwsResilienceHub service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "resiliencehub" }
func (p *Provider) ServiceName() string           { return "AwsResilienceHub" }
...
func init() {
	plugin.DefaultRegistry.Register("resiliencehub", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
