...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/artifact"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Artifact service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "artifact" }
func (p *Provider) ServiceName() string           { return "Artifact" }
...
func init() {
	plugin.DefaultRegistry.Register("artifact", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
