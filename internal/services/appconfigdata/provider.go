...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/appconfigdata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AppConfigData service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "appconfigdata" }
func (p *Provider) ServiceName() string           { return "AppConfigData" }
...
func init() {
	plugin.DefaultRegistry.Register("appconfigdata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
