...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/simpledbv2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SimpleDBv2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "simpledbv2" }
func (p *Provider) ServiceName() string           { return "SimpleDBv2" }
...
func init() {
	plugin.DefaultRegistry.Register("simpledbv2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
