...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/greengrassv2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GreengrassV2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "greengrassv2" }
func (p *Provider) ServiceName() string           { return "GreengrassV2" }
...
func init() {
	plugin.DefaultRegistry.Register("greengrassv2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
