...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplaceagreement"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MPCommerceService_v20200301 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplaceagreement" }
func (p *Provider) ServiceName() string           { return "MPCommerceService_v20200301" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplaceagreement", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
