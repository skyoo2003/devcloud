...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/rtbfabric"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RTBFabric service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "rtbfabric" }
func (p *Provider) ServiceName() string           { return "RTBFabric" }
...
func init() {
	plugin.DefaultRegistry.Register("rtbfabric", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
