...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotmanagedintegrations"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IotManagedIntegrations service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotmanagedintegrations" }
func (p *Provider) ServiceName() string           { return "IotManagedIntegrations" }
...
func init() {
	plugin.DefaultRegistry.Register("iotmanagedintegrations", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
