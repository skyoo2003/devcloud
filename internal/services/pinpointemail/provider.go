...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pinpointemail"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PinpointEmailService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pinpointemail" }
func (p *Provider) ServiceName() string           { return "PinpointEmailService" }
...
func init() {
	plugin.DefaultRegistry.Register("pinpointemail", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
