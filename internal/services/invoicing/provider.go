...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/invoicing"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Invoicing service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "invoicing" }
func (p *Provider) ServiceName() string           { return "Invoicing" }
...
func init() {
	plugin.DefaultRegistry.Register("invoicing", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
