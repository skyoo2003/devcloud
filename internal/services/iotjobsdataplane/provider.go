...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotjobsdataplane"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IotLaserThingJobManagerExternalService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotjobsdataplane" }
func (p *Provider) ServiceName() string           { return "IotLaserThingJobManagerExternalService" }
...
func init() {
	plugin.DefaultRegistry.Register("iotjobsdataplane", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
