...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connect" }
func (p *Provider) ServiceName() string           { return "ConnectService" }
...
func init() {
	plugin.DefaultRegistry.Register("connect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
