...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/datapipeline"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DataPipeline service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "datapipeline" }
func (p *Provider) ServiceName() string           { return "DataPipeline" }
...
func init() {
	plugin.DefaultRegistry.Register("datapipeline", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
