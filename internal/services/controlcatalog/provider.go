...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/controlcatalog"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ControlCatalog service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "controlcatalog" }
func (p *Provider) ServiceName() string           { return "ControlCatalog" }
...
func init() {
	plugin.DefaultRegistry.Register("controlcatalog", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
