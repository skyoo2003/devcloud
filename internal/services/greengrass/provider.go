...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/greengrass"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Greengrass service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "greengrass" }
func (p *Provider) ServiceName() string           { return "Greengrass" }
...
func init() {
	plugin.DefaultRegistry.Register("greengrass", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
