...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/directoryservicedata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DirectoryServiceData service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "directoryservicedata" }
func (p *Provider) ServiceName() string           { return "DirectoryServiceData" }
...
func init() {
	plugin.DefaultRegistry.Register("directoryservicedata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
