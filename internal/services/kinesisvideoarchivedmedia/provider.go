...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kinesisvideoarchivedmedia"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AcuityReader service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kinesisvideoarchivedmedia" }
func (p *Provider) ServiceName() string           { return "AcuityReader" }
...
func init() {
	plugin.DefaultRegistry.Register("kinesisvideoarchivedmedia", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
