...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/partnercentralselling"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PartnerCentralSelling service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "partnercentralselling" }
func (p *Provider) ServiceName() string           { return "PartnerCentralSelling" }
...
func init() {
	plugin.DefaultRegistry.Register("partnercentralselling", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
