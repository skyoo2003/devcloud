...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cognitosync"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CognitoSyncService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cognitosync" }
func (p *Provider) ServiceName() string           { return "CognitoSyncService" }
...
func init() {
	plugin.DefaultRegistry.Register("cognitosync", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
