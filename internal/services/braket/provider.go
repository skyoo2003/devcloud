...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/braket"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Braket service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "braket" }
func (p *Provider) ServiceName() string           { return "Braket" }
...
func init() {
	plugin.DefaultRegistry.Register("braket", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
