...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplaceentitlementservice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MPEntitlementService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplaceentitlementservice" }
func (p *Provider) ServiceName() string           { return "MPEntitlementService" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplaceentitlementservice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
