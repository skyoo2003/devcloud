...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotsecuretunneling"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IoTSecuredTunneling service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotsecuretunneling" }
func (p *Provider) ServiceName() string           { return "IoTSecuredTunneling" }
...
func init() {
	plugin.DefaultRegistry.Register("iotsecuretunneling", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
