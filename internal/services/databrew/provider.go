...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/databrew"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GlueDataBrew service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "databrew" }
func (p *Provider) ServiceName() string           { return "GlueDataBrew" }
...
func init() {
	plugin.DefaultRegistry.Register("databrew", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
