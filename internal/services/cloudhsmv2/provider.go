...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cloudhsmv2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BaldrApiService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cloudhsmv2" }
func (p *Provider) ServiceName() string           { return "BaldrApiService" }
...
func init() {
	plugin.DefaultRegistry.Register("cloudhsmv2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
