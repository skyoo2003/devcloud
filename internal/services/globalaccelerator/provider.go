...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/globalaccelerator"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GlobalAccelerator_V20180706 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "globalaccelerator" }
func (p *Provider) ServiceName() string           { return "GlobalAccelerator_V20180706" }
...
func init() {
	plugin.DefaultRegistry.Register("globalaccelerator", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
