...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/notifications"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Notifications service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "notifications" }
func (p *Provider) ServiceName() string           { return "Notifications" }
...
func init() {
	plugin.DefaultRegistry.Register("notifications", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
