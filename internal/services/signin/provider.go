...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/signin"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Signin service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "signin" }
func (p *Provider) ServiceName() string           { return "Signin" }
...
func init() {
	plugin.DefaultRegistry.Register("signin", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
