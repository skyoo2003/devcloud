...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/notificationscontacts"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NotificationsContacts service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "notificationscontacts" }
func (p *Provider) ServiceName() string           { return "NotificationsContacts" }
...
func init() {
	plugin.DefaultRegistry.Register("notificationscontacts", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
