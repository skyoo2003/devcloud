...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/networkmonitor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NetworkMonitor service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "networkmonitor" }
func (p *Provider) ServiceName() string           { return "NetworkMonitor" }
...
func init() {
	plugin.DefaultRegistry.Register("networkmonitor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
