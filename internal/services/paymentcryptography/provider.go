...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/paymentcryptography"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PaymentCryptographyControlPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "paymentcryptography" }
func (p *Provider) ServiceName() string           { return "PaymentCryptographyControlPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("paymentcryptography", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
