...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mpa"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the FluffyCoreService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mpa" }
func (p *Provider) ServiceName() string           { return "FluffyCoreService" }
...
func init() {
	plugin.DefaultRegistry.Register("mpa", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
