...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/personalizeevents"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PersonalizeEvents service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "personalizeevents" }
func (p *Provider) ServiceName() string           { return "PersonalizeEvents" }
...
func init() {
	plugin.DefaultRegistry.Register("personalizeevents", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
