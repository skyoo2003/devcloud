...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/rbin"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RecycleBin service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "rbin" }
func (p *Provider) ServiceName() string           { return "RecycleBin" }
...
func init() {
	plugin.DefaultRegistry.Register("rbin", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
