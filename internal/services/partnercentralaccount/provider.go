...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/partnercentralaccount"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PartnerCentralAccount service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "partnercentralaccount" }
func (p *Provider) ServiceName() string           { return "PartnerCentralAccount" }
...
func init() {
	plugin.DefaultRegistry.Register("partnercentralaccount", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
