...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/partnercentralchannel"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PartnerCentralChannel service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "partnercentralchannel" }
func (p *Provider) ServiceName() string           { return "PartnerCentralChannel" }
...
func init() {
	plugin.DefaultRegistry.Register("partnercentralchannel", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
