...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediaconnect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaConnect service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediaconnect" }
func (p *Provider) ServiceName() string           { return "MediaConnect" }
...
func init() {
	plugin.DefaultRegistry.Register("mediaconnect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
