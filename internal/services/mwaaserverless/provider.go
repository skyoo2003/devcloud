...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mwaaserverless"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MWAAServerless service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mwaaserverless" }
func (p *Provider) ServiceName() string           { return "MWAAServerless" }
...
func init() {
	plugin.DefaultRegistry.Register("mwaaserverless", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
