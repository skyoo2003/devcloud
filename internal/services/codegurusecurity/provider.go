...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/codegurusecurity"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AwsCodeGuruSecurity service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "codegurusecurity" }
func (p *Provider) ServiceName() string           { return "AwsCodeGuruSecurity" }
...
func init() {
	plugin.DefaultRegistry.Register("codegurusecurity", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
