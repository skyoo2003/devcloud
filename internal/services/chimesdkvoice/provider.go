...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chimesdkvoice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ChimeSDKTelephonyService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chimesdkvoice" }
func (p *Provider) ServiceName() string           { return "ChimeSDKTelephonyService" }
...
func init() {
	plugin.DefaultRegistry.Register("chimesdkvoice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
