...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/wellarchitected"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WellArchitectedApiServiceLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "wellarchitected" }
func (p *Provider) ServiceName() string           { return "WellArchitectedApiServiceLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("wellarchitected", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
