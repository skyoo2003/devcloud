...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/s3outposts"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the S3Outposts service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "s3outposts" }
func (p *Provider) ServiceName() string           { return "S3Outposts" }
...
func init() {
	plugin.DefaultRegistry.Register("s3outposts", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
