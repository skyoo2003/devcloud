...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connectcases"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectCases service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connectcases" }
func (p *Provider) ServiceName() string           { return "ConnectCases" }
...
func init() {
	plugin.DefaultRegistry.Register("connectcases", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
