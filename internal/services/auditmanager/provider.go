...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/auditmanager"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockAssessmentManagerLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "auditmanager" }
func (p *Provider) ServiceName() string           { return "BedrockAssessmentManagerLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("auditmanager", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
