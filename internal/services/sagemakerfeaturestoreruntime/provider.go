...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sagemakerfeaturestoreruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SageMakerFeatureStoreRuntime service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sagemakerfeaturestoreruntime" }
func (p *Provider) ServiceName() string           { return "SageMakerFeatureStoreRuntime" }
...
func init() {
	plugin.DefaultRegistry.Register("sagemakerfeaturestoreruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
