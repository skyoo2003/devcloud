...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/resiliencehubv2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NGRHServiceCore service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "resiliencehubv2" }
func (p *Provider) ServiceName() string           { return "NGRHServiceCore" }
...
func init() {
	plugin.DefaultRegistry.Register("resiliencehubv2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
