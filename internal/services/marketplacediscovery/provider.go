...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplacediscovery"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MarketplaceDiscovery service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplacediscovery" }
func (p *Provider) ServiceName() string           { return "MarketplaceDiscovery" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplacediscovery", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
