...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sagemakeredge"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SageMakerEdge service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sagemakeredge" }
func (p *Provider) ServiceName() string           { return "SageMakerEdge" }
...
func init() {
	plugin.DefaultRegistry.Register("sagemakeredge", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
