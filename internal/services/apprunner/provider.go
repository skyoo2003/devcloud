...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/apprunner"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AppRunner service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "apprunner" }
func (p *Provider) ServiceName() string           { return "AppRunner" }
...
func init() {
	plugin.DefaultRegistry.Register("apprunner", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
