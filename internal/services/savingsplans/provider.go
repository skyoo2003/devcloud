...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/savingsplans"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SavingsPlan service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "savingsplans" }
func (p *Provider) ServiceName() string           { return "SavingsPlan" }
...
func init() {
	plugin.DefaultRegistry.Register("savingsplans", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
