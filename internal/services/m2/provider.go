...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/m2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AwsSupernovaControlPlaneService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "m2" }
func (p *Provider) ServiceName() string           { return "AwsSupernovaControlPlaneService" }
...
func init() {
	plugin.DefaultRegistry.Register("m2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
