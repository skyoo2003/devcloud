...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediapackagevod"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaPackageVod service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediapackagevod" }
func (p *Provider) ServiceName() string           { return "MediaPackageVod" }
...
func init() {
	plugin.DefaultRegistry.Register("mediapackagevod", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
