...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bcmrecommendedactions"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BillingAndCostManagementRecommendedActions service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bcmrecommendedactions" }
func (p *Provider) ServiceName() string           { return "BillingAndCostManagementRecommendedActions" }
...
func init() {
	plugin.DefaultRegistry.Register("bcmrecommendedactions", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
