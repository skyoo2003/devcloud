...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/appflow"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SandstoneConfigurationServiceLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "appflow" }
func (p *Provider) ServiceName() string           { return "SandstoneConfigurationServiceLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("appflow", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
