...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/licensemanagerlinuxsubscriptions"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LicenseManagerLinuxSubscriptions service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "licensemanagerlinuxsubscriptions" }
func (p *Provider) ServiceName() string           { return "LicenseManagerLinuxSubscriptions" }
...
func init() {
	plugin.DefaultRegistry.Register("licensemanagerlinuxsubscriptions", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
