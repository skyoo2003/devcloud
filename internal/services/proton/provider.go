...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/proton"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AwsProton20200720 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "proton" }
func (p *Provider) ServiceName() string           { return "AwsProton20200720" }
...
func init() {
	plugin.DefaultRegistry.Register("proton", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
