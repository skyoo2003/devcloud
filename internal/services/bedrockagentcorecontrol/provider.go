...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockagentcorecontrol"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockAgentCoreControl service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockagentcorecontrol" }
func (p *Provider) ServiceName() string           { return "BedrockAgentCoreControl" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockagentcorecontrol", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
