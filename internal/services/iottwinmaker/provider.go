...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iottwinmaker"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IoTTwinMaker service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iottwinmaker" }
func (p *Provider) ServiceName() string           { return "IoTTwinMaker" }
...
func init() {
	plugin.DefaultRegistry.Register("iottwinmaker", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
