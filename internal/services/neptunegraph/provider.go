...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/neptunegraph"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NeptuneGraph service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "neptunegraph" }
func (p *Provider) ServiceName() string           { return "NeptuneGraph" }
...
func init() {
	plugin.DefaultRegistry.Register("neptunegraph", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
