...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workspacesinstances"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the EUCMIFrontendAPIService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workspacesinstances" }
func (p *Provider) ServiceName() string           { return "EUCMIFrontendAPIService" }
...
func init() {
	plugin.DefaultRegistry.Register("workspacesinstances", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
