...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lexruntimeservice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DeepSenseRunTimeService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lexruntimeservice" }
func (p *Provider) ServiceName() string           { return "DeepSenseRunTimeService" }
...
func init() {
	plugin.DefaultRegistry.Register("lexruntimeservice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
