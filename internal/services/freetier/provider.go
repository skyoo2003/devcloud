...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/freetier"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the FreeTierService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "freetier" }
func (p *Provider) ServiceName() string           { return "FreeTierService" }
...
func init() {
	plugin.DefaultRegistry.Register("freetier", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
