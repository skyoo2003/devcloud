...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/devicefarm"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DeviceFarm_20150623 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "devicefarm" }
func (p *Provider) ServiceName() string           { return "DeviceFarm_20150623" }
...
func init() {
	plugin.DefaultRegistry.Register("devicefarm", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
