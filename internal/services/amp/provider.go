...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/amp"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PrometheusService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "amp" }
func (p *Provider) ServiceName() string           { return "PrometheusService" }
...
func init() {
	plugin.DefaultRegistry.Register("amp", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
