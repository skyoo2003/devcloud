...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/osis"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the OpenSearchIngestionService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "osis" }
func (p *Provider) ServiceName() string           { return "OpenSearchIngestionService" }
...
func init() {
	plugin.DefaultRegistry.Register("osis", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
