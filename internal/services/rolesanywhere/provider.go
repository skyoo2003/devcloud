...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/rolesanywhere"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RolesAnywhere service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "rolesanywhere" }
func (p *Provider) ServiceName() string           { return "RolesAnywhere" }
...
func init() {
	plugin.DefaultRegistry.Register("rolesanywhere", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
