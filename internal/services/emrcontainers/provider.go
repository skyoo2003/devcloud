...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/emrcontainers"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AwsChicagoWebService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "emrcontainers" }
func (p *Provider) ServiceName() string           { return "AwsChicagoWebService" }
...
func init() {
	plugin.DefaultRegistry.Register("emrcontainers", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
