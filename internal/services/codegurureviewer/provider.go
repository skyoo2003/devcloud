...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/codegurureviewer"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GuruFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "codegurureviewer" }
func (p *Provider) ServiceName() string           { return "GuruFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("codegurureviewer", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
