...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ssmcontacts"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SSMContacts service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ssmcontacts" }
func (p *Provider) ServiceName() string           { return "SSMContacts" }
...
func init() {
	plugin.DefaultRegistry.Register("ssmcontacts", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
