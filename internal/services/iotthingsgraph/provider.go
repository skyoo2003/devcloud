...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotthingsgraph"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IotThingsGraphFrontEndService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotthingsgraph" }
func (p *Provider) ServiceName() string           { return "IotThingsGraphFrontEndService" }
...
func init() {
	plugin.DefaultRegistry.Register("iotthingsgraph", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
