...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediapackage"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaPackage service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediapackage" }
func (p *Provider) ServiceName() string           { return "MediaPackage" }
...
func init() {
	plugin.DefaultRegistry.Register("mediapackage", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
