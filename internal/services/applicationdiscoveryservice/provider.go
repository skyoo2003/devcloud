...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/applicationdiscoveryservice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PoseidonService_V2015_11_01 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "applicationdiscoveryservice" }
func (p *Provider) ServiceName() string           { return "PoseidonService_V2015_11_01" }
...
func init() {
	plugin.DefaultRegistry.Register("applicationdiscoveryservice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
