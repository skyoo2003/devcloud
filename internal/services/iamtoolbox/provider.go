...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iamtoolbox"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AuthRequestService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iamtoolbox" }
func (p *Provider) ServiceName() string           { return "AuthRequestService" }
...
func init() {
	plugin.DefaultRegistry.Register("iamtoolbox", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
