...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/polly"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Parrot_v1 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "polly" }
func (p *Provider) ServiceName() string           { return "Parrot_v1" }
...
func init() {
	plugin.DefaultRegistry.Register("polly", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
