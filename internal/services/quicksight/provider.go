...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/quicksight"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the QuickSight_20180401 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "quicksight" }
func (p *Provider) ServiceName() string           { return "QuickSight_20180401" }
...
func init() {
	plugin.DefaultRegistry.Register("quicksight", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
