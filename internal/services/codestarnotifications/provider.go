...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/codestarnotifications"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CodeStarNotifications_20191015 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "codestarnotifications" }
func (p *Provider) ServiceName() string           { return "CodeStarNotifications_20191015" }
...
func init() {
	plugin.DefaultRegistry.Register("codestarnotifications", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
