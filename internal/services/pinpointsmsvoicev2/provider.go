...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pinpointsmsvoicev2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PinpointSMSVoiceV2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pinpointsmsvoicev2" }
func (p *Provider) ServiceName() string           { return "PinpointSMSVoiceV2" }
...
func init() {
	plugin.DefaultRegistry.Register("pinpointsmsvoicev2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
