...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/schemas"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the schemas service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "schemas" }
func (p *Provider) ServiceName() string           { return "schemas" }
...
func init() {
	plugin.DefaultRegistry.Register("schemas", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
