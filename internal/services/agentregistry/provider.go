...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/agentregistry"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AgentRegistry service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "agentregistry" }
func (p *Provider) ServiceName() string           { return "AgentRegistry" }
...
func init() {
	plugin.DefaultRegistry.Register("agentregistry", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
