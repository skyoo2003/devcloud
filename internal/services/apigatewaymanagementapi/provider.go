...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/apigatewaymanagementapi"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ApiGatewayManagementApi service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "apigatewaymanagementapi" }
func (p *Provider) ServiceName() string           { return "ApiGatewayManagementApi" }
...
func init() {
	plugin.DefaultRegistry.Register("apigatewaymanagementapi", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
