...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/tnb"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the TNB service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "tnb" }
func (p *Provider) ServiceName() string           { return "TNB" }
...
func init() {
	plugin.DefaultRegistry.Register("tnb", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
