...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chimesdkmediapipelines"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ChimeSDKMediaPipelinesService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chimesdkmediapipelines" }
func (p *Provider) ServiceName() string           { return "ChimeSDKMediaPipelinesService" }
...
func init() {
	plugin.DefaultRegistry.Register("chimesdkmediapipelines", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
