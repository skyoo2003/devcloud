...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/applicationsignals"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ApplicationSignals service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "applicationsignals" }
func (p *Provider) ServiceName() string           { return "ApplicationSignals" }
...
func init() {
	plugin.DefaultRegistry.Register("applicationsignals", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
