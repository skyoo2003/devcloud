...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/redshiftserverless"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RedshiftServerless service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "redshiftserverless" }
func (p *Provider) ServiceName() string           { return "RedshiftServerless" }
...
func init() {
	plugin.DefaultRegistry.Register("redshiftserverless", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
