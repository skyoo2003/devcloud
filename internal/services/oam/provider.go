...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/oam"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the oamservice service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "oam" }
func (p *Provider) ServiceName() string           { return "oamservice" }
...
func init() {
	plugin.DefaultRegistry.Register("oam", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
