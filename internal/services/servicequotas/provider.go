...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/servicequotas"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ServiceQuotasV20190624 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "servicequotas" }
func (p *Provider) ServiceName() string           { return "ServiceQuotasV20190624" }
...
func init() {
	plugin.DefaultRegistry.Register("servicequotas", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
