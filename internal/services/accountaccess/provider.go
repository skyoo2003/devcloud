...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/accountaccess"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AccountAccess service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "accountaccess" }
func (p *Provider) ServiceName() string           { return "AccountAccess" }
...
func init() {
	plugin.DefaultRegistry.Register("accountaccess", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
