...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/applicationcostprofiler"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ApplicationCostProfiler service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "applicationcostprofiler" }
func (p *Provider) ServiceName() string           { return "ApplicationCostProfiler" }
...
func init() {
	plugin.DefaultRegistry.Register("applicationcostprofiler", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
