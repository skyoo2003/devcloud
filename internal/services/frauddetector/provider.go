...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/frauddetector"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the HawksNestServiceFacade service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "frauddetector" }
func (p *Provider) ServiceName() string           { return "HawksNestServiceFacade" }
...
func init() {
	plugin.DefaultRegistry.Register("frauddetector", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
