...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/finspacedata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the HabaneroPublicAPI service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "finspacedata" }
func (p *Provider) ServiceName() string           { return "HabaneroPublicAPI" }
...
func init() {
	plugin.DefaultRegistry.Register("finspacedata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
