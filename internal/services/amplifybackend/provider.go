...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/amplifybackend"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AmplifyBackend service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "amplifybackend" }
func (p *Provider) ServiceName() string           { return "AmplifyBackend" }
...
func init() {
	plugin.DefaultRegistry.Register("amplifybackend", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
