...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connectparticipant"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectParticipantServiceLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connectparticipant" }
func (p *Provider) ServiceName() string           { return "ConnectParticipantServiceLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("connectparticipant", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
