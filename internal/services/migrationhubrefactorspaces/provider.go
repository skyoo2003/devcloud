...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/migrationhubrefactorspaces"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RefactorSpaces service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "migrationhubrefactorspaces" }
func (p *Provider) ServiceName() string           { return "RefactorSpaces" }
...
func init() {
	plugin.DefaultRegistry.Register("migrationhubrefactorspaces", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
