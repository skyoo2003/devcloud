...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/route53recoverycontrolconfig"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Route53RecoveryControlConfig service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "route53recoverycontrolconfig" }
func (p *Provider) ServiceName() string           { return "Route53RecoveryControlConfig" }
...
func init() {
	plugin.DefaultRegistry.Register("route53recoverycontrolconfig", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
