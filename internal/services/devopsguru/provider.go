...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/devopsguru"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CapstoneControlPlaneService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "devopsguru" }
func (p *Provider) ServiceName() string           { return "CapstoneControlPlaneService" }
...
func init() {
	plugin.DefaultRegistry.Register("devopsguru", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
