...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/datasync"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the FmrsService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "datasync" }
func (p *Provider) ServiceName() string           { return "FmrsService" }
...
func init() {
	plugin.DefaultRegistry.Register("datasync", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
