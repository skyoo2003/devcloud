...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/qconnect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WisdomService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "qconnect" }
func (p *Provider) ServiceName() string           { return "WisdomService" }
...
func init() {
	plugin.DefaultRegistry.Register("qconnect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
