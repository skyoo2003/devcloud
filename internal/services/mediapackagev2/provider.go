...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediapackagev2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the mediapackagev2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediapackagev2" }
func (p *Provider) ServiceName() string           { return "mediapackagev2" }
...
func init() {
	plugin.DefaultRegistry.Register("mediapackagev2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
