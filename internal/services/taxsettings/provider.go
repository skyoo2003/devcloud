...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/taxsettings"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the TaxSettings service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "taxsettings" }
func (p *Provider) ServiceName() string           { return "TaxSettings" }
...
func init() {
	plugin.DefaultRegistry.Register("taxsettings", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
