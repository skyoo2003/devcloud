...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/vpclattice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MercuryControlPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "vpclattice" }
func (p *Provider) ServiceName() string           { return "MercuryControlPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("vpclattice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
