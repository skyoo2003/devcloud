...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/computeoptimizer"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ComputeOptimizerService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "computeoptimizer" }
func (p *Provider) ServiceName() string           { return "ComputeOptimizerService" }
...
func init() {
	plugin.DefaultRegistry.Register("computeoptimizer", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
