...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/wisdom"
...
func (p *Provider) ServiceID() string             { return "wisdom" }
...
func init() {
	plugin.DefaultRegistry.Register("wisdom", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
