...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/geomaps"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MapsService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "geomaps" }
func (p *Provider) ServiceName() string           { return "MapsService" }
...
func init() {
	plugin.DefaultRegistry.Register("geomaps", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
