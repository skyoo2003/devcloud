...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/accessanalyzer"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AccessAnalyzer service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "accessanalyzer" }
func (p *Provider) ServiceName() string           { return "AccessAnalyzer" }
...
func init() {
	plugin.DefaultRegistry.Register("accessanalyzer", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
