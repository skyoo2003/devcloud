...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connectcampaignsv2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectCampaignServiceV2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connectcampaignsv2" }
func (p *Provider) ServiceName() string           { return "ConnectCampaignServiceV2" }
...
func init() {
	plugin.DefaultRegistry.Register("connectcampaignsv2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
