...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bcmpricingcalculator"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BCMPricingCalculator service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bcmpricingcalculator" }
func (p *Provider) ServiceName() string           { return "BCMPricingCalculator" }
...
func init() {
	plugin.DefaultRegistry.Register("bcmpricingcalculator", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
