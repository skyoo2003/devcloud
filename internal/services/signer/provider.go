...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/signer"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WallabyService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "signer" }
func (p *Provider) ServiceName() string           { return "WallabyService" }
...
func init() {
	plugin.DefaultRegistry.Register("signer", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
