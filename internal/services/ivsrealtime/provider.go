...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ivsrealtime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the InteractiveVideoServiceRealTime service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ivsrealtime" }
func (p *Provider) ServiceName() string           { return "InteractiveVideoServiceRealTime" }
...
func init() {
	plugin.DefaultRegistry.Register("ivsrealtime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
