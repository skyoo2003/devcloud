...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotsitewise"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IoTSiteWise service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotsitewise" }
func (p *Provider) ServiceName() string           { return "IoTSiteWise" }
...
func init() {
	plugin.DefaultRegistry.Register("iotsitewise", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
