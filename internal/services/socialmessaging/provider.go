...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/socialmessaging"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SocialMessaging service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "socialmessaging" }
func (p *Provider) ServiceName() string           { return "SocialMessaging" }
...
func init() {
	plugin.DefaultRegistry.Register("socialmessaging", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
