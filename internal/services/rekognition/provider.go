...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/rekognition"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RekognitionService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "rekognition" }
func (p *Provider) ServiceName() string           { return "RekognitionService" }
...
func init() {
	plugin.DefaultRegistry.Register("rekognition", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
