...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/costoptimizationhub"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CostOptimizationHubService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "costoptimizationhub" }
func (p *Provider) ServiceName() string           { return "CostOptimizationHubService" }
...
func init() {
	plugin.DefaultRegistry.Register("costoptimizationhub", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
