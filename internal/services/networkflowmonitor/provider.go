...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/networkflowmonitor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NetworkFlowMonitor service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "networkflowmonitor" }
func (p *Provider) ServiceName() string           { return "NetworkFlowMonitor" }
...
func init() {
	plugin.DefaultRegistry.Register("networkflowmonitor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
