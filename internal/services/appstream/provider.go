...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/appstream"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PhotonAdminProxyService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "appstream" }
func (p *Provider) ServiceName() string           { return "PhotonAdminProxyService" }
...
func init() {
	plugin.DefaultRegistry.Register("appstream", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
