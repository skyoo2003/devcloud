...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ivschat"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the InteractiveVideoServiceChat service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ivschat" }
func (p *Provider) ServiceName() string           { return "InteractiveVideoServiceChat" }
...
func init() {
	plugin.DefaultRegistry.Register("ivschat", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
