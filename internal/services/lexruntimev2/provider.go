...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lexruntimev2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DeepSenseRunTimeServiceApi2_0 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lexruntimev2" }
func (p *Provider) ServiceName() string           { return "DeepSenseRunTimeServiceApi2_0" }
...
func init() {
	plugin.DefaultRegistry.Register("lexruntimev2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
