...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kinesisvideo"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KinesisVideo_20170930 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kinesisvideo" }
func (p *Provider) ServiceName() string           { return "KinesisVideo_20170930" }
...
func init() {
	plugin.DefaultRegistry.Register("kinesisvideo", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
