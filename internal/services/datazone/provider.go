...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/datazone"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DataZone service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "datazone" }
func (p *Provider) ServiceName() string           { return "DataZone" }
...
func init() {
	plugin.DefaultRegistry.Register("datazone", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
