...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/customerprofiles"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CustomerProfiles_20200815 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "customerprofiles" }
func (p *Provider) ServiceName() string           { return "CustomerProfiles_20200815" }
...
func init() {
	plugin.DefaultRegistry.Register("customerprofiles", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
