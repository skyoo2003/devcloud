...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/opensearchserverless"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the OpenSearchServerless service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "opensearchserverless" }
func (p *Provider) ServiceName() string           { return "OpenSearchServerless" }
...
func init() {
	plugin.DefaultRegistry.Register("opensearchserverless", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
