...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/wafregional"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the WAF_Regional_20161128 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "wafregional" }
func (p *Provider) ServiceName() string           { return "WAF_Regional_20161128" }
...
func init() {
	plugin.DefaultRegistry.Register("wafregional", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
