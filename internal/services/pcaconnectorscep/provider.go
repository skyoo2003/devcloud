...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pcaconnectorscep"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PcaConnectorScep service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pcaconnectorscep" }
func (p *Provider) ServiceName() string           { return "PcaConnectorScep" }
...
func init() {
	plugin.DefaultRegistry.Register("pcaconnectorscep", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
