...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/guardduty"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GuardDutyAPIService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "guardduty" }
func (p *Provider) ServiceName() string           { return "GuardDutyAPIService" }
...
func init() {
	plugin.DefaultRegistry.Register("guardduty", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
