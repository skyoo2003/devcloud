...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bcmdataexports"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BillingAndCostManagementDataExports service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bcmdataexports" }
func (p *Provider) ServiceName() string           { return "BillingAndCostManagementDataExports" }
...
func init() {
	plugin.DefaultRegistry.Register("bcmdataexports", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
