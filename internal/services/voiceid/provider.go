...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/voiceid"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the VoiceID service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "voiceid" }
func (p *Provider) ServiceName() string           { return "VoiceID" }
...
func init() {
	plugin.DefaultRegistry.Register("voiceid", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
