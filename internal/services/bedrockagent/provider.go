...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockagent"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockAgentBuildTimeLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockagent" }
func (p *Provider) ServiceName() string           { return "BedrockAgentBuildTimeLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockagent", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
