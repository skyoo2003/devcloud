...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/drs"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ElasticDisasterRecoveryService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "drs" }
func (p *Provider) ServiceName() string           { return "ElasticDisasterRecoveryService" }
...
func init() {
	plugin.DefaultRegistry.Register("drs", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
