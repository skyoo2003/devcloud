...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplacemetering"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MPMeteringService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplacemetering" }
func (p *Provider) ServiceName() string           { return "MPMeteringService" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplacemetering", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
