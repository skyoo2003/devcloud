...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/b2bi"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the B2BI service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "b2bi" }
func (p *Provider) ServiceName() string           { return "B2BI" }
...
func init() {
	plugin.DefaultRegistry.Register("b2bi", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
