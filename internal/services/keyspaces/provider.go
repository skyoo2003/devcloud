...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/keyspaces"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KeyspacesService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "keyspaces" }
func (p *Provider) ServiceName() string           { return "KeyspacesService" }
...
func init() {
	plugin.DefaultRegistry.Register("keyspaces", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
