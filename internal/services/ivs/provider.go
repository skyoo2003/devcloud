...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ivs"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the InteractiveVideoService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ivs" }
func (p *Provider) ServiceName() string           { return "InteractiveVideoService" }
...
func init() {
	plugin.DefaultRegistry.Register("ivs", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
