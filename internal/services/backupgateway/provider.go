...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/backupgateway"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BackupOnPremises_v20210101 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "backupgateway" }
func (p *Provider) ServiceName() string           { return "BackupOnPremises_v20210101" }
...
func init() {
	plugin.DefaultRegistry.Register("backupgateway", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
