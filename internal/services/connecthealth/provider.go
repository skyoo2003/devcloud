...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connecthealth"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectHealth service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connecthealth" }
func (p *Provider) ServiceName() string           { return "ConnectHealth" }
...
func init() {
	plugin.DefaultRegistry.Register("connecthealth", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
