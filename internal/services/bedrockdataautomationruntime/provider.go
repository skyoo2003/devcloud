...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockdataautomationruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockKeystoneRuntimeService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockdataautomationruntime" }
func (p *Provider) ServiceName() string           { return "BedrockKeystoneRuntimeService" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockdataautomationruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
