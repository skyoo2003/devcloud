...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/amplifyuibuilder"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AmplifyUIBuilder service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "amplifyuibuilder" }
func (p *Provider) ServiceName() string           { return "AmplifyUIBuilder" }
...
func init() {
	plugin.DefaultRegistry.Register("amplifyuibuilder", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
