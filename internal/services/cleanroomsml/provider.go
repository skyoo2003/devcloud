...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cleanroomsml"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the StarkControlService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cleanroomsml" }
func (p *Provider) ServiceName() string           { return "StarkControlService" }
...
func init() {
	plugin.DefaultRegistry.Register("cleanroomsml", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
