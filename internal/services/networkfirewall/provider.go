...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/networkfirewall"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NetworkFirewall_20201112 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "networkfirewall" }
func (p *Provider) ServiceName() string           { return "NetworkFirewall_20201112" }
...
func init() {
	plugin.DefaultRegistry.Register("networkfirewall", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
