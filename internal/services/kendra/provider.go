...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kendra"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KendraFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kendra" }
func (p *Provider) ServiceName() string           { return "KendraFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("kendra", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
