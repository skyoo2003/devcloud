...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/elasticloadbalancing"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ElasticLoadBalancing_v7 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "elasticloadbalancing" }
func (p *Provider) ServiceName() string           { return "ElasticLoadBalancing_v7" }
...
func init() {
	plugin.DefaultRegistry.Register("elasticloadbalancing", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
