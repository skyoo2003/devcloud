...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workmailmessageflow"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GiraffeMessageInTransitService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workmailmessageflow" }
func (p *Provider) ServiceName() string           { return "GiraffeMessageInTransitService" }
...
func init() {
	plugin.DefaultRegistry.Register("workmailmessageflow", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
