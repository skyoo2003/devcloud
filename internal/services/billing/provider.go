...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/billing"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Billing service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "billing" }
func (p *Provider) ServiceName() string           { return "Billing" }
...
func init() {
	plugin.DefaultRegistry.Register("billing", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
