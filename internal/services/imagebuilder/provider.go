...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/imagebuilder"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the imagebuilder service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "imagebuilder" }
func (p *Provider) ServiceName() string           { return "imagebuilder" }
...
func init() {
	plugin.DefaultRegistry.Register("imagebuilder", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
