...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/s3vectors"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the S3Vectors service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "s3vectors" }
func (p *Provider) ServiceName() string           { return "S3Vectors" }
...
func init() {
	plugin.DefaultRegistry.Register("s3vectors", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
