...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/cloudwatchevents"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Events service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "cloudwatchevents" }
func (p *Provider) ServiceName() string           { return "Events" }
...
func init() {
	plugin.DefaultRegistry.Register("cloudwatchevents", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
