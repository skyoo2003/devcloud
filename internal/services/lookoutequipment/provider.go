...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lookoutequipment"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LookoutEquipmentFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lookoutequipment" }
func (p *Provider) ServiceName() string           { return "LookoutEquipmentFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("lookoutequipment", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
