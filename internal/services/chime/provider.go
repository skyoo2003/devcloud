...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the UCBuzzConsoleService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chime" }
func (p *Provider) ServiceName() string           { return "UCBuzzConsoleService" }
...
func init() {
	plugin.DefaultRegistry.Register("chime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
