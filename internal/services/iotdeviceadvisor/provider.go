...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotdeviceadvisor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IotSenateService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotdeviceadvisor" }
func (p *Provider) ServiceName() string           { return "IotSenateService" }
...
func init() {
	plugin.DefaultRegistry.Register("iotdeviceadvisor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
