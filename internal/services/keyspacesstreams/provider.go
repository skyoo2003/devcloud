...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/keyspacesstreams"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KeyspacesStreams service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "keyspacesstreams" }
func (p *Provider) ServiceName() string           { return "KeyspacesStreams" }
...
func init() {
	plugin.DefaultRegistry.Register("keyspacesstreams", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
