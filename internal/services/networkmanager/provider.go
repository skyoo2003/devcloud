...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/networkmanager"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the NetworkManager service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "networkmanager" }
func (p *Provider) ServiceName() string           { return "NetworkManager" }
...
func init() {
	plugin.DefaultRegistry.Register("networkmanager", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
