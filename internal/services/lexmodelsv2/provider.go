...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lexmodelsv2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LexModelBuildingServiceV2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lexmodelsv2" }
func (p *Provider) ServiceName() string           { return "LexModelBuildingServiceV2" }
...
func init() {
	plugin.DefaultRegistry.Register("lexmodelsv2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
