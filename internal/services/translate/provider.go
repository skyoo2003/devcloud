...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/translate"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ShineFrontendService_20170701 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "translate" }
func (p *Provider) ServiceName() string           { return "ShineFrontendService_20170701" }
...
func init() {
	plugin.DefaultRegistry.Register("translate", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
