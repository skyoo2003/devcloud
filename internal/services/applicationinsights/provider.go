...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/applicationinsights"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the EC2WindowsBarleyService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "applicationinsights" }
func (p *Provider) ServiceName() string           { return "EC2WindowsBarleyService" }
...
func init() {
	plugin.DefaultRegistry.Register("applicationinsights", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
