...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/apigateway"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BackplaneControlService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "apigateway" }
func (p *Provider) ServiceName() string           { return "BackplaneControlService" }
...
func init() {
	plugin.DefaultRegistry.Register("apigateway", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
