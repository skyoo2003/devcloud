...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/fms"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the FMS_20180101 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "fms" }
func (p *Provider) ServiceName() string           { return "FMS_20180101" }
...
func init() {
	plugin.DefaultRegistry.Register("fms", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
