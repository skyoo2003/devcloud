...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/snowball"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IESnowballJobManagementService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "snowball" }
func (p *Provider) ServiceName() string           { return "IESnowballJobManagementService" }
...
func init() {
	plugin.DefaultRegistry.Register("snowball", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
