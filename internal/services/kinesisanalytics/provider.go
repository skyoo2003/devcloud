...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kinesisanalytics"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KinesisAnalytics_20150814 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kinesisanalytics" }
func (p *Provider) ServiceName() string           { return "KinesisAnalytics_20150814" }
...
func init() {
	plugin.DefaultRegistry.Register("kinesisanalytics", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
