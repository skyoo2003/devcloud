...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/observabilityadmin"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ObservabilityAdmin service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "observabilityadmin" }
func (p *Provider) ServiceName() string           { return "ObservabilityAdmin" }
...
func init() {
	plugin.DefaultRegistry.Register("observabilityadmin", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
