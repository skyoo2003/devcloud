...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mailmanager"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MailManagerSvc service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mailmanager" }
func (p *Provider) ServiceName() string           { return "MailManagerSvc" }
...
func init() {
	plugin.DefaultRegistry.Register("mailmanager", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
