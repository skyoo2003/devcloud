...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/finspace"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the HabaneroManagementService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "finspace" }
func (p *Provider) ServiceName() string           { return "HabaneroManagementService" }
...
func init() {
	plugin.DefaultRegistry.Register("finspace", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
