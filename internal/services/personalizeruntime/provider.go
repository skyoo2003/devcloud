...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/personalizeruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PersonalizeRuntime service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "personalizeruntime" }
func (p *Provider) ServiceName() string           { return "PersonalizeRuntime" }
...
func init() {
	plugin.DefaultRegistry.Register("personalizeruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
