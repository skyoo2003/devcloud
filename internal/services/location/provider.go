...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/location"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LocationService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "location" }
func (p *Provider) ServiceName() string           { return "LocationService" }
...
func init() {
	plugin.DefaultRegistry.Register("location", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
