...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/dax"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DAXV3 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "dax" }
func (p *Provider) ServiceName() string           { return "DAXV3" }
...
func init() {
	plugin.DefaultRegistry.Register("dax", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
