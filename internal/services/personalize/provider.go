...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/personalize"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Personalize service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "personalize" }
func (p *Provider) ServiceName() string           { return "Personalize" }
...
func init() {
	plugin.DefaultRegistry.Register("personalize", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
