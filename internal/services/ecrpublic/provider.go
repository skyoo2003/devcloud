...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ecrpublic"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SpencerFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ecrpublic" }
func (p *Provider) ServiceName() string           { return "SpencerFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("ecrpublic", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
