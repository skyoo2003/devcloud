...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/billingconductor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BillingConductor service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "billingconductor" }
func (p *Provider) ServiceName() string           { return "BillingConductor" }
...
func init() {
	plugin.DefaultRegistry.Register("billingconductor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
