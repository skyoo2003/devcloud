...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/ssmincidents"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SSMIncidents service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "ssmincidents" }
func (p *Provider) ServiceName() string           { return "SSMIncidents" }
...
func init() {
	plugin.DefaultRegistry.Register("ssmincidents", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
