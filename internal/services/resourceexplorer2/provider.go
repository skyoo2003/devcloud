...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/resourceexplorer2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ResourceExplorer service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "resourceexplorer2" }
func (p *Provider) ServiceName() string           { return "ResourceExplorer" }
...
func init() {
	plugin.DefaultRegistry.Register("resourceexplorer2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
