...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockdataautomation"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockKeystoneBuildTimeService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockdataautomation" }
func (p *Provider) ServiceName() string           { return "BedrockKeystoneBuildTimeService" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockdataautomation", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
