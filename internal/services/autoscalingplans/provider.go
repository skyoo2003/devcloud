...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/autoscalingplans"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AnyScaleScalingPlannerFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "autoscalingplans" }
func (p *Provider) ServiceName() string           { return "AnyScaleScalingPlannerFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("autoscalingplans", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
