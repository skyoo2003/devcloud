...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplacedeployment"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MPDeploymentParametersService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplacedeployment" }
func (p *Provider) ServiceName() string           { return "MPDeploymentParametersService" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplacedeployment", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
