...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lexmodelbuildingservice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DeepSenseModelBuildingService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lexmodelbuildingservice" }
func (p *Provider) ServiceName() string           { return "DeepSenseModelBuildingService" }
...
func init() {
	plugin.DefaultRegistry.Register("lexmodelbuildingservice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
