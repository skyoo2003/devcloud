...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/groundstation"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GroundStation service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "groundstation" }
func (p *Provider) ServiceName() string           { return "GroundStation" }
...
func init() {
	plugin.DefaultRegistry.Register("groundstation", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
