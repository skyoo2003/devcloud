...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/codecatalyst"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CodeCatalyst service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "codecatalyst" }
func (p *Provider) ServiceName() string           { return "CodeCatalyst" }
...
func init() {
	plugin.DefaultRegistry.Register("codecatalyst", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
