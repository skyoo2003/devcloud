...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/medicalimaging"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AHIGatewayService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "medicalimaging" }
func (p *Provider) ServiceName() string           { return "AHIGatewayService" }
...
func init() {
	plugin.DefaultRegistry.Register("medicalimaging", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
