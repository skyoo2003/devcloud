...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/outposts"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the OutpostsOlafService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "outposts" }
func (p *Provider) ServiceName() string           { return "OutpostsOlafService" }
...
func init() {
	plugin.DefaultRegistry.Register("outposts", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
