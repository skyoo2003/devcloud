...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/licensemanager"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LicenseManager service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "licensemanager" }
func (p *Provider) ServiceName() string           { return "LicenseManager" }
...
func init() {
	plugin.DefaultRegistry.Register("licensemanager", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
