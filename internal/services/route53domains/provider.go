...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/route53domains"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Route53Domains_v20140515 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "route53domains" }
func (p *Provider) ServiceName() string           { return "Route53Domains_v20140515" }
...
func init() {
	plugin.DefaultRegistry.Register("route53domains", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
