...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/odb"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Odb service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "odb" }
func (p *Provider) ServiceName() string           { return "Odb" }
...
func init() {
	plugin.DefaultRegistry.Register("odb", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
