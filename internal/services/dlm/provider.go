...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/dlm"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the dlm_20180112 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "dlm" }
func (p *Provider) ServiceName() string           { return "dlm_20180112" }
...
func init() {
	plugin.DefaultRegistry.Register("dlm", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
