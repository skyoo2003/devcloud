...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/backupsearch"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the CryoBackupSearchService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "backupsearch" }
func (p *Provider) ServiceName() string           { return "CryoBackupSearchService" }
...
func init() {
	plugin.DefaultRegistry.Register("backupsearch", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
