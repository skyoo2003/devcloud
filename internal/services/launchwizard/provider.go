...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/launchwizard"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the LaunchWizard service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "launchwizard" }
func (p *Provider) ServiceName() string           { return "LaunchWizard" }
...
func init() {
	plugin.DefaultRegistry.Register("launchwizard", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
