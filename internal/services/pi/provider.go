...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pi"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PerformanceInsightsv20180227 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pi" }
func (p *Provider) ServiceName() string           { return "PerformanceInsightsv20180227" }
...
func init() {
	plugin.DefaultRegistry.Register("pi", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
