...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/securitylake"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SecurityLake service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "securitylake" }
func (p *Provider) ServiceName() string           { return "SecurityLake" }
...
func init() {
	plugin.DefaultRegistry.Register("securitylake", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
