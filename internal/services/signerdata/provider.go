...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/signerdata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SignerDataPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "signerdata" }
func (p *Provider) ServiceName() string           { return "SignerDataPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("signerdata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
