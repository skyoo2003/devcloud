...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/gameliftstreams"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GameLiftStreams service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "gameliftstreams" }
func (p *Provider) ServiceName() string           { return "GameLiftStreams" }
...
func init() {
	plugin.DefaultRegistry.Register("gameliftstreams", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
