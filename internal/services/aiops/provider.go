...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/aiops"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AIOps service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "aiops" }
func (p *Provider) ServiceName() string           { return "AIOps" }
...
func init() {
	plugin.DefaultRegistry.Register("aiops", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
