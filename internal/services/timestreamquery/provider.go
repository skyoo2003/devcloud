...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/timestreamquery"
...
func (p *Provider) ServiceID() string             { return "timestreamquery" }
...
func init() {
	plugin.DefaultRegistry.Register("timestreamquery", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
