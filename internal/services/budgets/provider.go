...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/budgets"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BudgetServiceGateway service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "budgets" }
func (p *Provider) ServiceName() string           { return "BudgetServiceGateway" }
...
func init() {
	plugin.DefaultRegistry.Register("budgets", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
