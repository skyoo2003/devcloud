...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/repostspace"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the RepostSpace service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "repostspace" }
func (p *Provider) ServiceName() string           { return "RepostSpace" }
...
func init() {
	plugin.DefaultRegistry.Register("repostspace", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
