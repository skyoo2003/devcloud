...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/partnercentralrevenuemeasurement"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PartnerCentralRevenueMeasurement service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "partnercentralrevenuemeasurement" }
func (p *Provider) ServiceName() string           { return "PartnerCentralRevenueMeasurement" }
...
func init() {
	plugin.DefaultRegistry.Register("partnercentralrevenuemeasurement", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
