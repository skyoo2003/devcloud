...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/servicecatalogappregistry"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the 242AppRegistry service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "servicecatalogappregistry" }
func (p *Provider) ServiceName() string           { return "242AppRegistry" }
...
func init() {
	plugin.DefaultRegistry.Register("servicecatalogappregistry", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
