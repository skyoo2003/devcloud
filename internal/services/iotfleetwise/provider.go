...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/iotfleetwise"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the IoTAutobahnControlPlane service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "iotfleetwise" }
func (p *Provider) ServiceName() string           { return "IoTAutobahnControlPlane" }
...
func init() {
	plugin.DefaultRegistry.Register("iotfleetwise", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
