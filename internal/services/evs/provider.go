...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/evs"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ElasticVMwareService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "evs" }
func (p *Provider) ServiceName() string           { return "ElasticVMwareService" }
...
func init() {
	plugin.DefaultRegistry.Register("evs", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
