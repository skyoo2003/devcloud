...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/snowdevicemanagement"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SnowDeviceManagement service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "snowdevicemanagement" }
func (p *Provider) ServiceName() string           { return "SnowDeviceManagement" }
...
func init() {
	plugin.DefaultRegistry.Register("snowdevicemanagement", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
