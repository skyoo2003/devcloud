...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/docdbelastic"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ChimeraDbLionfishServiceLambda service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "docdbelastic" }
func (p *Provider) ServiceName() string           { return "ChimeraDbLionfishServiceLambda" }
...
func init() {
	plugin.DefaultRegistry.Register("docdbelastic", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
