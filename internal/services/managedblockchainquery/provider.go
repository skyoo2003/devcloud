...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/managedblockchainquery"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the TietonChainQueryService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "managedblockchainquery" }
func (p *Provider) ServiceName() string           { return "TietonChainQueryService" }
...
func init() {
	plugin.DefaultRegistry.Register("managedblockchainquery", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
