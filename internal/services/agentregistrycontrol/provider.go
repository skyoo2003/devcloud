...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/agentregistrycontrol"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AgentRegistryControl service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "agentregistrycontrol" }
func (p *Provider) ServiceName() string           { return "AgentRegistryControl" }
...
func init() {
	plugin.DefaultRegistry.Register("agentregistrycontrol", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
