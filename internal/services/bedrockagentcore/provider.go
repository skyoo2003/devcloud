...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockagentcore"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockAgentCore service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockagentcore" }
func (p *Provider) ServiceName() string           { return "BedrockAgentCore" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockagentcore", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
