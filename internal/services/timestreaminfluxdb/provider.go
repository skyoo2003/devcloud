...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/timestreaminfluxdb"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the TimestreamInfluxDB service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "timestreaminfluxdb" }
func (p *Provider) ServiceName() string           { return "TimestreamInfluxDB" }
...
func init() {
	plugin.DefaultRegistry.Register("timestreaminfluxdb", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
