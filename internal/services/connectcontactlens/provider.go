...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/connectcontactlens"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ConnectContactLens service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "connectcontactlens" }
func (p *Provider) ServiceName() string           { return "ConnectContactLens" }
...
func init() {
	plugin.DefaultRegistry.Register("connectcontactlens", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
