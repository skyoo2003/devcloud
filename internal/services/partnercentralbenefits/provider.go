...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/partnercentralbenefits"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PartnerCentralBenefitsService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "partnercentralbenefits" }
func (p *Provider) ServiceName() string           { return "PartnerCentralBenefitsService" }
...
func init() {
	plugin.DefaultRegistry.Register("partnercentralbenefits", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
