...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/macie2"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Macie2 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "macie2" }
func (p *Provider) ServiceName() string           { return "Macie2" }
...
func init() {
	plugin.DefaultRegistry.Register("macie2", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
