...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/lightsail"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Lightsail_20161128 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "lightsail" }
func (p *Provider) ServiceName() string           { return "Lightsail_20161128" }
...
func init() {
	plugin.DefaultRegistry.Register("lightsail", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
