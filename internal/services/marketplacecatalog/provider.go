...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/marketplacecatalog"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MPSeymour service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "marketplacecatalog" }
func (p *Provider) ServiceName() string           { return "MPSeymour" }
...
func init() {
	plugin.DefaultRegistry.Register("marketplacecatalog", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
