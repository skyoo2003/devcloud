...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/fsx"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SimbaAPIService_v20180301 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "fsx" }
func (p *Provider) ServiceName() string           { return "SimbaAPIService_v20180301" }
...
func init() {
	plugin.DefaultRegistry.Register("fsx", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
