...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bedrockruntime"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BedrockFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bedrockruntime" }
func (p *Provider) ServiceName() string           { return "BedrockFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("bedrockruntime", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
