...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/supportapp"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SupportApp service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "supportapp" }
func (p *Provider) ServiceName() string           { return "SupportApp" }
...
func init() {
	plugin.DefaultRegistry.Register("supportapp", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
