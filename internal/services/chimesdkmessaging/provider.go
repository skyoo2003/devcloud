...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chimesdkmessaging"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ChimeMessagingService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chimesdkmessaging" }
func (p *Provider) ServiceName() string           { return "ChimeMessagingService" }
...
func init() {
	plugin.DefaultRegistry.Register("chimesdkmessaging", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
