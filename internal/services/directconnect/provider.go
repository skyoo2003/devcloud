...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/directconnect"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the OvertureService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "directconnect" }
func (p *Provider) ServiceName() string           { return "OvertureService" }
...
func init() {
	plugin.DefaultRegistry.Register("directconnect", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
