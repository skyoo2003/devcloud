...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/bcmdashboards"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the BCMDashboardsService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "bcmdashboards" }
func (p *Provider) ServiceName() string           { return "BCMDashboardsService" }
...
func init() {
	plugin.DefaultRegistry.Register("bcmdashboards", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
