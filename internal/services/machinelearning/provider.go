...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/machinelearning"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ML_20141212 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "machinelearning" }
func (p *Provider) ServiceName() string           { return "ML_20141212" }
...
func init() {
	plugin.DefaultRegistry.Register("machinelearning", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
