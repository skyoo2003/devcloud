...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/detective"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Detective service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "detective" }
func (p *Provider) ServiceName() string           { return "Detective" }
...
func init() {
	plugin.DefaultRegistry.Register("detective", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
