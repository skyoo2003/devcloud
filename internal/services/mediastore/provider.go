...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediastore"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaStore_20170901 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediastore" }
func (p *Provider) ServiceName() string           { return "MediaStore_20170901" }
...
func init() {
	plugin.DefaultRegistry.Register("mediastore", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
