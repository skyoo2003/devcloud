...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/comprehendmedical"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ComprehendMedical_20181030 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "comprehendmedical" }
func (p *Provider) ServiceName() string           { return "ComprehendMedical_20181030" }
...
func init() {
	plugin.DefaultRegistry.Register("comprehendmedical", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
