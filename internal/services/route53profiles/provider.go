...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/route53profiles"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Route53Profiles service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "route53profiles" }
func (p *Provider) ServiceName() string           { return "Route53Profiles" }
...
func init() {
	plugin.DefaultRegistry.Register("route53profiles", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
