...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mturk"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MTurkRequesterServiceV20170117 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mturk" }
func (p *Provider) ServiceName() string           { return "MTurkRequesterServiceV20170117" }
...
func init() {
	plugin.DefaultRegistry.Register("mturk", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
