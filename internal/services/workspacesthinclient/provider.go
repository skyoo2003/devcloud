...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/workspacesthinclient"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ThinClient service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "workspacesthinclient" }
func (p *Provider) ServiceName() string           { return "ThinClient" }
...
func init() {
	plugin.DefaultRegistry.Register("workspacesthinclient", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
