...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kinesisvideosignaling"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AcuitySignalingService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kinesisvideosignaling" }
func (p *Provider) ServiceName() string           { return "AcuitySignalingService" }
...
func init() {
	plugin.DefaultRegistry.Register("kinesisvideosignaling", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
