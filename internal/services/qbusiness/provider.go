...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/qbusiness"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ExpertQ service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "qbusiness" }
func (p *Provider) ServiceName() string           { return "ExpertQ" }
...
func init() {
	plugin.DefaultRegistry.Register("qbusiness", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
