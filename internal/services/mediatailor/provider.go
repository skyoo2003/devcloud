...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediatailor"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaTailor service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediatailor" }
func (p *Provider) ServiceName() string           { return "MediaTailor" }
...
func init() {
	plugin.DefaultRegistry.Register("mediatailor", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
