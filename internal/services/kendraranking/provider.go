...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/kendraranking"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the KendraRerankingFrontendService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "kendraranking" }
func (p *Provider) ServiceName() string           { return "KendraRerankingFrontendService" }
...
func init() {
	plugin.DefaultRegistry.Register("kendraranking", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
