...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sagemakermetrics"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SageMakerMetricsService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sagemakermetrics" }
func (p *Provider) ServiceName() string           { return "SageMakerMetricsService" }
...
func init() {
	plugin.DefaultRegistry.Register("sagemakermetrics", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
