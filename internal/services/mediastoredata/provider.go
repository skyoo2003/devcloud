...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/mediastoredata"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MediaStoreObject_20170901 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "mediastoredata" }
func (p *Provider) ServiceName() string           { return "MediaStoreObject_20170901" }
...
func init() {
	plugin.DefaultRegistry.Register("mediastoredata", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
