...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/dataexchange"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the DataExchange service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "dataexchange" }
func (p *Provider) ServiceName() string           { return "DataExchange" }
...
func init() {
	plugin.DefaultRegistry.Register("dataexchange", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
