...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/pinpointsmsvoice"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the PinpointSMSVoice service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "pinpointsmsvoice" }
func (p *Provider) ServiceName() string           { return "PinpointSMSVoice" }
...
func init() {
	plugin.DefaultRegistry.Register("pinpointsmsvoice", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
