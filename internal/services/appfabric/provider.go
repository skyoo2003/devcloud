...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/appfabric"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the FabricFrontEndService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "appfabric" }
func (p *Provider) ServiceName() string           { return "FabricFrontEndService" }
...
func init() {
	plugin.DefaultRegistry.Register("appfabric", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
