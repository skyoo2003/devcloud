...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/route53recoveryreadiness"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Route53RecoveryReadiness service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "route53recoveryreadiness" }
func (p *Provider) ServiceName() string           { return "Route53RecoveryReadiness" }
...
func init() {
	plugin.DefaultRegistry.Register("route53recoveryreadiness", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
