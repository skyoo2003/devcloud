...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/gamelift"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the GameLift service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "gamelift" }
func (p *Provider) ServiceName() string           { return "GameLift" }
...
func init() {
	plugin.DefaultRegistry.Register("gamelift", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
