...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/uxc"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AccountUXSetting service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "uxc" }
func (p *Provider) ServiceName() string           { return "AccountUXSetting" }
...
func init() {
	plugin.DefaultRegistry.Register("uxc", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
