...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/appintegrations"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the AppIntegrationService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "appintegrations" }
func (p *Provider) ServiceName() string           { return "AppIntegrationService" }
...
func init() {
	plugin.DefaultRegistry.Register("appintegrations", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
