...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/deadline"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Deadline service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "deadline" }
func (p *Provider) ServiceName() string           { return "Deadline" }
...
func init() {
	plugin.DefaultRegistry.Register("deadline", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
