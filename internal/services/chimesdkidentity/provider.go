...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/chimesdkidentity"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ChimeIdentityService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "chimesdkidentity" }
func (p *Provider) ServiceName() string           { return "ChimeIdentityService" }
...
func init() {
	plugin.DefaultRegistry.Register("chimesdkidentity", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
