...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/arcregionswitch"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ArcRegionSwitch service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "arcregionswitch" }
func (p *Provider) ServiceName() string           { return "ArcRegionSwitch" }
...
func init() {
	plugin.DefaultRegistry.Register("arcregionswitch", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
