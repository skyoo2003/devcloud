...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/sagemakergeospatial"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the SageMakerGeospatial service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "sagemakergeospatial" }
func (p *Provider) ServiceName() string           { return "SageMakerGeospatial" }
...
func init() {
	plugin.DefaultRegistry.Register("sagemakergeospatial", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
