...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/health"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the Health_20160804 service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "health" }
func (p *Provider) ServiceName() string           { return "Health_20160804" }
...
func init() {
	plugin.DefaultRegistry.Register("health", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
