...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/migrationhubstrategy"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the MigrationHubStrategyRecommendation service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "migrationhubstrategy" }
func (p *Provider) ServiceName() string           { return "MigrationHubStrategyRecommendation" }
...
func init() {
	plugin.DefaultRegistry.Register("migrationhubstrategy", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
