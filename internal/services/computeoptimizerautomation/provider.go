...
import (
	...
	generated "github.com/skyoo2003/devcloud/internal/generated/computeoptimizerautomation"
	"github.com/skyoo2003/devcloud/internal/plugin"
)

// Provider implements the ComputeOptimizerAutomationService service.
type Provider struct {
	generated.BaseProvider
	dataDir string
}

func (p *Provider) ServiceID() string             { return "computeoptimizerautomation" }
func (p *Provider) ServiceName() string           { return "ComputeOptimizerAutomationService" }
...
func init() {
	plugin.DefaultRegistry.Register("computeoptimizerautomation", func() plugin.ServicePlugin {
		return &Provider{}
	})
}
